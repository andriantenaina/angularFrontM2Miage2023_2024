...
@Component({
  ...
  standalone: true,
  imports: [FormsModule,RouterModule,MatFormFieldModule,MatIconModule,MatTooltipModule,MatButtonModule, 
    MatInputModule,MatCardModule,ReactiveFormsModule,MatStepperModule
  ],
...
export class RegisterComponent {
  ...
  register(event: any) {
    if((this.email == '') ||(this.name == '') || (this.password === undefined)) return;
    let user = new User();
